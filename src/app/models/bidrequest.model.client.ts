export class BidRequest {
	...
	webDesign?: boolean;
	webConsulting?: boolean;
	logoDesign?: boolean;
	flyerDesign?: boolean;
	businessTemplates?: boolean;
	eventCoordination?: boolean;
	eventAssistance?: boolean;
	eventConsulting?: boolean;
	artServices?: boolean;
	artCuration?: boolean;
	artAdvertisement?: boolean;
	bidPreferredBudget: string;
	bidProjectTitle: string;	
	bidDetailedDescription: string;
	bidDate: string;
	bidContactOne: string;
	bidContactTwo: string;
	bidPhone: string;
	bidEmail: string;
	bidWebsite: string;
